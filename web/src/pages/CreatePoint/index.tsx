...
const CreatePoint = () => {
    ...
    function handleSelectCiy(event: ChangeEvent<HTMLSelectElement>){
    ...
    return (
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    <legend><h2>Endereço</h2><span>O endereço do mapa</span></legend>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            ...
                            <select name="city" id="city" value={selectedCity} onChange={handleSelectCiy}>
